...
async function devout() {
    ...
    function getUIvals() {
        let props = {
            sys: { value: document.getElementById('prof').value },
            dpt: { value: document.getElementById('gdepth').value },
            ztype: { value: document.getElementById('ztype').innerText },
            zcolor: { value: document.getElementById('zlist').value },
            zgrp: { value: document.getElementById('zgrp').innerText },
            h: { value: document.getElementById('h').value },
            w: { value: document.getElementById('w').value },
            l: { value: document.getElementById('levo').value },
            p: { value: document.getElementById('pravo').value },
        };
...
`
    ...
    console.log(`со страницы: ${Object.keys(uivals)}`); //массив ключ:значение данных со страницы
    return uivals
}